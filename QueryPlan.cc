 ...
 * Print utilities                                                    *
 **********************************************************************/
void QueryNode::print(std::ostream& os, size_t level) {
...
void QueryNode::printOperator(std::ostream& os, size_t level)  {
  os << indent(level) << opName << ": ";
}

void QueryNode::printSchema(std::ostream& os, size_t level)  {
...
void LeafNode::printPipe(std::ostream& os, size_t level)  {
  os << annot(level) << "Output pipe: " << pout << endl;
}

void UnaryNode::printPipe(std::ostream& os, size_t level)  {
  os << annot(level) << "Output pipe: " << pout << endl;
  os << annot(level) << "Input pipe: " << pin << endl;
}

void BinaryNode::printPipe(std::ostream& os, size_t level)  {
  os << annot(level) << "Output pipe: " << pout << endl;
  os << annot(level) << "Input pipe: " << pleft << ", " << pright << endl;
}

void LeafNode::printOperator(std::ostream& os, size_t level)  {
  os << indent(level) << "Select from " << relNames[0] << ": ";
}

void LeafNode::printAnnot(std::ostream& os, size_t level)  {
  selOp.Print(); 
}

void ProjectNode::printAnnot(std::ostream& os, size_t level)  {
  os << keepMe[0];
...
void JoinNode::printAnnot(std::ostream& os, size_t level)  {
  selOp.Print();
  os << annot(level) << "Estimate = " << estimate << ", Cost = " << cost << endl;
}

void SumNode::printAnnot(std::ostream& os, size_t level)  {
  os << annot(level) << "Function: "; (const_cast<Function*>(&f))->Print();
}

void GroupByNode::printAnnot(std::ostream& os, size_t level)  {
  os << annot(level) << "OrderMaker: "; (const_cast<OrderMaker*>(&grpOrder))->Print();
  os << annot(level) << "Function: "; (const_cast<Function*>(&f))->Print();
}

void WriteNode::printAnnot(std::ostream& os, size_t level)  {
