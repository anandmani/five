...
protected:
  ...
  virtual void print(std::ostream& os = std::cout, size_t level = 0);
  virtual void printOperator(std::ostream& os = std::cout, size_t level = 0);
  virtual void printSchema(std::ostream& os = std::cout, size_t level = 0);
  virtual void printAnnot(std::ostream& os = std::cout, size_t level = 0) = 0; // operator specific
  virtual void printPipe(std::ostream& os, size_t level = 0) = 0;
  virtual void printChildren(std::ostream& os, size_t level = 0) = 0;
...
class LeafNode: private QueryNode {  // read from file
  ...
  void printOperator(std::ostream& os = std::cout, size_t level = 0);
  void printAnnot(std::ostream& os = std::cout, size_t level = 0);
  void printPipe(std::ostream& os, size_t level);
  void printChildren(std::ostream& os, size_t level){}
...
protected:
  ...
  void printPipe(std::ostream& os, size_t level);
  void printChildren(std::ostream& os, size_t level) { child->print(os, level+1); }
  QueryNode* child;
  int pin;  // input pipe
};
